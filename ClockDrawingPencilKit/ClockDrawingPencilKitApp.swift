...
struct ClockDrawingPencilKitApp: App {
    ...
    func setupUserDefaults() {
        if !UserDefaults.standard.bool(forKey: "startedVersion1.3") {

            UserDefaults.standard.set(false, forKey: "useMLforClockhands")
            ...
            UserDefaults.standard.set(true, forKey: "startedVersion1.3")
        }
    }
}
